...
class Team:
    ...
    def display_player_stats(self, player):
        ...
        Args:
            player (Player): The Player object for whom to display the stats.
        """
        print(f"Player: {player.name}")
        print(f"Bowling: {player.bowling}")
        print(f"Batting: {player.batting}")
        print(f"Fielding: {player.fielding}")
        print(f"Running: {player.running}")
...
class Match:
    ...
    def play_innings(self, batting_team, bowling_team):
        ...
        while over < self.total_overs:
            ...
            # Display stats of the batsman before playing a ball
            self.team1.display_player_stats(batsman)
...
player1 = []
for i in range(10):
    player1.append(Player("Player_"+str(i+1), round(random.random(),1), round(random.random(),1),round(random.random(),1), round(random.random(),1), round(random.random(),1)))

player2 = []
for i in range(10):
    player2.append(Player("Player_"+str(i+1), round(random.random(),1), round(random.random(),1),round(random.random(),1), round(random.random(),1), round(random.random(),1)))

# Adding players to team
team1 = Team("India", player1)
team2 = Team("Pakistan", player2)
